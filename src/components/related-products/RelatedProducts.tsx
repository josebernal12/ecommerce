...
const RelatedProducts = ({ product }: Props) => {
  ...
  return (
    <div className="ms-10 rounded-lg border bg-card text-card-foreground shadow-sm transition-transform duration-300 hover:scale-110 focus:outline-none" data-v0-t="card">
